"""Download script for Intent Classifier models."""
...
def main():
    parser = argparse.ArgumentParser(description="Download intent classification model")
    parser.add_argument(
        "--model",
    ...
    parser.add_argument(
        "--cache-dir",
        default="./models/cache/intent_classifier",
